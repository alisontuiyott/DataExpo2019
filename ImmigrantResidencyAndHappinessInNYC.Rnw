...
For a measure of the community, we choose crime at a precinct level. A community with high crime might negatively affect the happiness of the households in that area. This data is provided at the precinct level. Every precinct in New York City is unique and does not overlap with 
